                ...
                link: function ($scope, element, attrs, controller) {
                    ...
                    function select() {
                        ...
                        if (prediction.is_custom) {
                            $scope.details = prediction.place;
                            ...
                            placesService.getDetails({ placeId: prediction.place_id }, function (place, status) {
                                if (status == google.maps.places.PlacesServiceStatus.OK) {
                                    $scope.$apply(function () {
										//$scope.disablingValiderButton = 2;
										//alert($scope.disablingValiderButton);
                                        $scope.model = place;
                                        $scope.details = place;
                    ...
                    function format(modelValue) {
                        ...
                        if (isString(modelValue)) {
							...
							viewValue = modelValue.name + ', Paris, France';
							if (modelValue.address_components[0].short_name != 'FR') {
